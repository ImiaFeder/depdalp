...
<body class="bg-gray-100">
    ...
    <!-- Full Page Container -->
    <div class="flex items-center justify-center h-screen bg-gradient-to-r from-blue-500 to-green-500">
    
        <!-- App Introduction Container -->
        <div class="text-center text-white px-6 sm:px-12 md:px-24 max-w-3xl w-full space-y-8">
