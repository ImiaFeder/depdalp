    ...
    <nav class="bg-gradient-to-r from-red-600 to-black text-white p-4 shadow-lg">
        <div class="container mx-auto flex justify-between items-center">
            ...
            <ul class="flex space-x-6">
                <li><a href="{{ url('/home') }}"
                        class="hover:text-yellow-400 transition duration-300 ease-in-out">Home</a></li>
            ...
            <div class="ml-auto relative flex items-center">
                @auth
                    <button id="buytoken"
                        class="flex items-center mr-4 bg-white p-3 rounded-lg shadow-md transform transition-all hover:scale-105 hover:bg-red-100">
                ...
                @guest
                    @if (Route::has('login'))
                        <a href="{{ route('login') }}"
                            class="hover:text-yellow-400 transition duration-300 ease-in-out">Login</a>
                    @endif
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}"
                            class="hover:text-yellow-400 transition duration-300 ease-in-out ml-4">Register</a>
                    @endif
                @else
                    <!-- Dropdown button for logged-in user -->
                    <button id="userDropdownButton"
                        class="hover:text-yellow-400 focus:outline-none text-lg font-semibold flex items-center">
                    ...
                    <div id="userDropdownMenu"
                        class="hidden absolute right-0 mt-2 w-48 bg-white text-black shadow-lg rounded-lg z-10">
                        <a href="{{ route('profile') }}"
                            class="block px-4 py-2 hover:bg-gray-200 transition duration-200 ease-in-out">
                            Profile
                        </a>
                        <a href="#" class="block px-4 py-2 hover:bg-gray-200 transition duration-200 ease-in-out"
                ...
                <div class="w-full max-w-lg bg-white p-6 rounded-lg shadow-lg text-center">
                    ...
                    <div class="grid grid-cols-3 gap-4 mb-6">
                        <button id="btn15"
                            ...
                            <div
                                class="w-6 h-6 bg-orange-500 text-white rounded-full flex items-center justify-center mb-2">
                    ...
                    <form id="creditCardForm" class="hidden flex flex-col items-start mb-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label for="expiryDate" class="block text-left text-gray-700 font-semibold mb-2">Expiry
                                    Date</label>
