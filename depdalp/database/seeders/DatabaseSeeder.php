...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $videos = [
            ...
            ['title' => 'Mastering Photography Lighting', 'description' => 'Understand and master lighting for any photography shoot.', 'price' => rand(3, 5), 'path' => 'path/to/video5'],
            ['title' => 'Portrait Photography Tips', 'description' => 'Get the best tips for perfect portrait photography.', 'price' => rand(3, 5), 'path' => 'path/to/video6'],
            ['title' => 'Audiophile: The Ultimate Sound Systems', 'description' => 'Explore the world of audiophile sound systems and speakers.', 'price' => rand(3, 5), 'path' => 'path/to/video7'],
            ['title' => 'Building the Perfect Audiophile Setup', 'description' => 'How to set up an audiophile-grade sound system in your home.', 'price' => rand(3, 5), 'path' => 'path/to/video8'],
            ['title' => 'Essential Gym Workouts for Beginners', 'description' => 'A beginner’s guide to essential gym workouts for a full body routine.', 'price' => rand(3, 5), 'path' => 'path/to/video9'],
            ['title' => 'Strength Training for Building Muscle', 'description' => 'Focus on strength training for building muscle effectively.', 'price' => rand(3, 5), 'path' => 'path/to/video10'],
            ['title' => 'Social Media Marketing 101', 'description' => 'An introduction to social media marketing for businesses.', 'price' => rand(3, 5), 'path' => 'path/to/video11'],
            ['title' => 'Content Creation for Social Media', 'description' => 'Learn how to create engaging content for your social media platforms.', 'price' => rand(3, 5), 'path' => 'path/to/video12'],
            ['title' => 'Advanced Social Media Advertising', 'description' => 'Boost your social media presence with targeted advertising.', 'price' => rand(3, 5), 'path' => 'path/to/video13'],
